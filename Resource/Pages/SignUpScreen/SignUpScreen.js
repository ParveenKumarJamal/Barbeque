...
<View style={{marginTop:heightToDp('1'),width:widthToDp('90'),height:heightToDp('7'),borderRadius:widthToDp('1'),elevation:1}}> 
  <TextInput
  value={Name} 
  placeholder='Name'
...
<TouchableOpacity onPress={()=>SignIn()}>
  <View style={{width:widthToDp('35'),height:heightToDp('5.5'),justifyContent:'center',alignItems:'center',borderRadius:widthToDp('1.5'),marginTop:heightToDp('1'),elevation:1}}>
<Text style={{color:'#000',fontSize:widthToDp('4.5')}}>Sign In</Text>
</View>  
</TouchableOpacity>
